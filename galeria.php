    ...
    <div class="col-12">
        <div class="card card-secondary">
            <div class="card-header">
                <h4 class="card-title">Imagenes del Inmueble</h4>
            </div>
            <div class="card-body">
                <div>
                    <div class="btn-group w-100 mb-2">
                    <a class="btn btn-info active" href="javascript:void(0)" data-filter="all"> Todas las Imagenes </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="1"> Ilustradas </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="2"> Interior </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="3"> Exterior </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="4"> Zona de Ubicación </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="4"> Vista Superior (Tipología) </a>
                    </div>
                    <div class="mb-2">
                    <div class="float-right">
                        <select class="custom-select" style="width: auto;" data-sortOrder>
                        <option value="index"> Ordenar </option>
